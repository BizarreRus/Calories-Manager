...
<%@ taglib prefix="custom_tags" tagdir="/WEB-INF/tags" %>
        ...
        <div class="shadow">
            ...
            <div class="view-box">
                <form:form modelAttribute="userTo" class="form-horizontal" method="post" action="${register ? 'register' : 'profile'}"
                    ...
                    <custom_tags:inputField label='${userName}' name="name"/>

                    <spring:message code="users.email" var="userEmail"/>
                    <custom_tags:inputField label='${userEmail}' name="email"/>

                    <spring:message code="users.password" var="userPassword"/>
                    <custom_tags:inputField label='${userPassword}' name="password" inputType="password"/>

                    <spring:message code="users.caloriesPerDay" var="caloriesPerDay"/>
                    <custom_tags:inputField label='${caloriesPerDay}' name="caloriesPerDay" inputType="number"/>
